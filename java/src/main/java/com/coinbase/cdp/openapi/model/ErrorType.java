...
public enum ErrorType {
  ...
  ONRAMP_OTP_VERIFICATION_CODE_INVALID("onramp_otp_verification_code_invalid"),
  
  ONRAMP_OTP_VERIFICATION_DESTINATION_MISMATCH("onramp_otp_verification_destination_mismatch"),
  
  ONRAMP_OTP_VERIFICATION_EXPIRED("onramp_otp_verification_expired"),
  
  ONRAMP_OTP_VERIFICATION_INVALID("onramp_otp_verification_invalid"),
  
  ONRAMP_OTP_VERIFICATION_NOT_FOUND("onramp_otp_verification_not_found"),
  
  ONRAMP_OTP_VERIFICATION_REQUIRED("onramp_otp_verification_required"),
